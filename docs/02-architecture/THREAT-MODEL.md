...
| PT-13 | `assertFenceIsSound`: the wrapped output opens and closes with the label exactly once and contains no `<` in between, for arbitrary peer input. | shared unit | v1:test/tools/fetch.test.ts:86-93, 328-357 | F1 |
