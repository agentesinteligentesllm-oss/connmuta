...
|---|---|
| Date | 2026-09-17 |
| Subject | PR-09a (`registry/schema.ts` + `registry/invariants.ts` + the new `registry` compile unit + the shared roster-entry schema export, each with its twin), on branch `f1/09-registry`; audited range `e177c58..010ed85`. PR-09 was re-sliced at apply time into PR-09a and PR-09b because the whole measured 1,570 authored lines against a ≈380 estimate. |
| Authority | **The Director**, who owns DN-05 |
